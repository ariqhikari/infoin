<div>
    <label for="" class="section-title mt-0">Ubah Event</label>
    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <form wire:submit.prevent="update">
                ...
                <div class="form-group">
                    <img src="{{ Storage::url($eventMap) }}" width="80px" class="img-thumbnail mb-2" alt="">
                ...
                <div class="form-group">
                    <img src="{{ Storage::url($eventThumb) }}" width="80px" class="img-thumbnail mb-2" alt="">
                    <div class="alert alert-info" role="alert">
                        Kosongkan jika tidak akan diganti
                    </div>
                    <br>
                ...
                @if ($regency_id != null)
                    <button type="submit" class="btn btn-warning btn-block">Ubah Event</button>
                @endif
                <button class="btn btn-danger btn-block" type="button" wire:click="batal()">Batal Ubah</button>
            </form>
        </div>
    </div>
</div>